                                            ...
                                            <table style="width:89.333333%;max-width:536px;margin:auto;border-collapse:collapse">
                                                <tr>
                                                    <td style="padding:0">
                                                        ...
                                                        <a href=${data.href} style="font-family:Lato;font-weight:400;font-size:13px;line-height:20px;text-align:center;letter-spacing:.25px;color:#db2693;padding:6px 16px;background:#f7f7f7;border-radius:6px;margin:auto;margin-top:14px;display:block;width:200px;text-decoration:none">${data.hrefText}</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
